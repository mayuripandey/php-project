...
?>
					...
					<thead>
								...
								<?php
								$query="select propertyid,propertycode,casecode,`case`.status,caseid from `case`
								INNER JOIN property ON `case`.plotid=propertyid;
								";
								if(isset($_GET['startdate']) && isset($_GET['enddate'])){
									$query="select properycode,casecode,`case`.status from `case`
								INNER JOIN property ON `case`.plotid=propertyid
								...
								<tr>
								<td><a href="dhapropertydes.php?id=<?php echo$res['propertyid']; ?>"><?php echo $res['propertycode']; ?></a></td>
								<?php
								...
								?>
								<td><a href="casedetails.php?id=<?php echo$res['caseid']; ?>"><?php echo $res['casecode']; ?></td>
								<?php
								}?>
