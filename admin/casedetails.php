			...
			<div class="span6">
				...
				<div class="span12">
					<div class="row-fluid">		
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Case Summary</div>
		                            </div>
		                            <div class="block-content collapse in">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									<thead>
									...
									<tr>
										...
										<tr>
										<td>Total Files</td>
										<td><?php echo $row['plotgenerated']; ?></td>
										</tr>
										<tr>
										<td>Files Owned By Medlinks</td>
										<td><?php echo $row['medlinkplots']; ?></td>
										</tr>
										<tr>
										<tr>
										<td>Files Owned by Owner</td>
										<td><?php echo $row['clientplots']; ?></td>
										</tr>
										<tr>
										<td>Files Owned by DHA</td>
										<td><?php echo $row['dhaplots']; ?></td>
