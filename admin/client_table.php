...
<div id="block_bg" class="block" style="margin-top: 30px;">
					...
					<p>Are you sure you want to delete Client you check?.</p>
					</div>
					</div>
					...
					<button name="delete_client" class="btn btn-danger"><i class="icon-check icon-large"></i> Yes</button>
									...
									<td width="120"><a href="de_activate_client.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i> Deactivate</a></td>
									<?php }else{ ?>
									<td width="120"><a href="activate_client.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i> Activated</a></td>				
									<?php } ?>
                                </tr>
                            <?php } ?>
