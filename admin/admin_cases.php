...
<div class="block">
	<div class="navbar navbar-inner block-header">
		...
		<?php $query = mysql_query("select `case`.caseid,casecode,plot.plotid,plotcode,marla,kanal,`plot`.picture,price
				...
				Left Join client on `case`.clientid=`client`.clientid")or die(mysql_error());
  			...
  			<ul	 id="da-thumbs" class="da-thumbs">
				...
				?>
					<li style="display: inline; list-style-type: none; ">
						...
						<img src ="../admin/<?php echo $row['picture'] ?>" width="200px" height="200px" class="img-polaroid">
						<div>
							<span>
								<p>Plot Code:</p>
								...
								<p> <?php echo $row['marla']." Marlas";?></p>
									...
									<i class="icon-info-sign"></i> NO case Opened.
									</div>
									<?php } ?>	
			</ul>
