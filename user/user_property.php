...
<div class="block">
	<div class="navbar navbar-inner block-header">
		...
		<?php $query = mysql_query("select plotid,plotcode,marla,kanal,picture,price from plot
				where status='unsold'")or die(mysql_error());
  			...
  			<ul	 id="da-thumbs" class="da-thumbs">
				...
				?>
					<li style="display: inline; list-style-type: none; ">
						<a href="plotdetails.php<?php echo '?id='.$id; ?>">
						...
						<div>
							<span>
								...
								<p> <?php echo $row['marla']." Marlas";?></p>
									...
									<?php }}else{ ?>
									<div class="alert alert-info"><i class="icon-info-sign"></i> No plot Availabe</div>
									<?php } ?>	
			</ul>
