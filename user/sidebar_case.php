...
?>
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li><a href="dashboard.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Properties</a></li>
			<li class="active">
				<a href="case.php"><i class="icon-chevron-right"></i><i class="icon-info-sign"></i>&nbsp;Case</a>
			</li>
			<li class="">
