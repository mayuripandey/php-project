...
<?php
$id=$_GET['id'];
$sql=mysql_query("select count(employeeid) as count from `casefile` where casefileid=$id AND employeeid=$emp_id");
$res=mysql_fetch_array($sql);
if($res['count']<=0){
header("location: dhafile.php");
}
?>
